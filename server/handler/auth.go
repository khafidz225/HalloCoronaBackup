...
func (h *handlerAuth) Register(w http.ResponseWriter, r *http.Request) {
	...
	response := dto.SuccessResult{Code: http.StatusOK, Data: convertResRegister(data)}
	json.NewEncoder(w).Encode(response)
}
...
func convertResRegister(u models.User) authdto.RegisterRespons {
